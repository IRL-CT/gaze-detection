...
<body>
    ...
    <!--<div style="padding: 10px;">
        <div style="height: 50%; display: grid; place-items: center;"><h2>APPROACH</h2></div>
        <div style="height: 50%; display: grid; place-items: center;"><h2>DNI</h2></div>
    </div>-->
...
def generate_frames():
    ...
    while cap.isOpened():
        ...
        if not ret: # catch bad conversions
            continue
